...
const members = [
  ["Yoo-Joo Choi", "Lab Director / Professor", "Computer Graphics · Image Analysis · Human-Computer Interaction", "/members/yoo-joo-choi.png"],
  ["Yu-Min Kim", "M.S. Student", "Augmented Reality · 3D Gaussian Splatting", "/members/yu-min-kim.jpg"],
  ["Yu-Bin Kim", "M.S. Student", "3D Gaussian Splatting · Digital Human", "/members/yu-bin-choi.jpg"],
];
...
export default function EnglishHome() {
  return <main>
    ...
    <section className="hero" id="top"><video className="hero-video" autoPlay muted loop playsInline preload="metadata" aria-hidden="true"><source src="/hero-vcar.mp4" type="video/mp4" /></video><div className="hero-video-overlay" aria-hidden="true" /><p className="eyebrow">Seoul, Korea · Est. 2021</p><h1>Visual Computing<br /><em>&amp; Augmented Reality</em></h1><div className="hero-bottom"><p>Between technology and perception,<br />we create new scenes of reality.</p><span>Scroll to enter ↓</span></div></section>
