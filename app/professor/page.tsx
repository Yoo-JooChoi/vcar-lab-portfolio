...
export default function ProfessorPage() {
  return <main className="professor-page">
    <nav className="nav" aria-label="주요 탐색"><a className="wordmark" href="/">VCAR<br />LAB.</a><div className="nav-links"><a href="/#about">About</a><a href="/#members">Members</a><a href="/#contact">Contact</a></div></nav>
    <header className="professor-hero"><p className="eyebrow">Professor / 01</p><p className="professor-kicker">Visual Computing &amp; Augmented Reality Lab.</p><h1>최유주<br /><em>Yoo-Joo Choi</em></h1><div className="professor-meta"><p>Professor<br />서울미디어대학원대학교 인공지능응용소프트웨어학과</p><p><a href="mailto:yjchoi@smit.ac.kr">yjchoi@smit.ac.kr</a><br />02-6953-3154 · 010-6215-0241</p></div></header>
